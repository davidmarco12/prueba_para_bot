...
function promedioNotas14(a, b, c) {
  const promedio = (a + b + c) / 3;
  console.log("Promedio: " + promedio);
}

// Función duplicada sin sentido
function promedioNotas24(x, y, z) {
